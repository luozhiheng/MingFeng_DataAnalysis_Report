...
import numpy as np
import re
from readdata import date_interval
import formula as formula
from formula import nominal_capacity
# import statistics method
...
def show_electricity_consumption_diff(dt_in, freq=8):
    dates_result1 = date_interval(dt_in, freq)
    dates1 = dates_result1[0]  # x轴的时间序列
    step1 = dates_result1[1]  # 时间间隔的步长
    # 计算系统负荷
    ...
    # 计算原系统、新系统电费
    electric_charge_simulate = formula.cal_electric_charge(dt_in, power_simulate)
    electric_charge_retrofit = formula.cal_electric_charge(dt_in, power_retrofit)
